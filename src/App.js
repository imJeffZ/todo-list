...
function Todo({ todo, removeTodo, completeTodo, discompleteTodo, index }) {
  return (
    <div 
      className="todo"
      onClick={() => todo.iscomplete ? discompleteTodo(index) : completeTodo(index)}
    >
      <div 
        className="task"
        style={{
...
function App () {
  ...
  const [todos, setTodos] = useState(localTodos || INIT_TODOS);
